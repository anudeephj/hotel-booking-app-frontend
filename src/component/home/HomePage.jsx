        ...
        <div className="home">
            <section>
                <header className="header-banner">
                    <img src={`${process.env.PUBLIC_URL}/images/bg.jpg`} alt="Hotel" className="header-image" />
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content">
                        <h1>Welcome to <span className="phegon-color">Auriela Hotels</span></h1> <br/>
            ...
            <h2 className="home-services">Services at <span className="phegon-color">Auriela Hotels</span></h2>

            {/* SERVICES SECTION */}
            <section className="service-section"><div className="service-card">
                <img src={`${process.env.PUBLIC_URL}/images/ac.png`} alt="Air Conditioning" />
                ...
                <div className="service-card">
                    <img src={`${process.env.PUBLIC_URL}/images/mini-bar.png`} alt="Mini Bar" />
                    <div className="service-details">
                ...
                <div className="service-card">
                    <img src={`${process.env.PUBLIC_URL}/images/parking.png`} alt="Parking" />
                    <div className="service-details">
                ...
                <div className="service-card">
                    <img src={`${process.env.PUBLIC_URL}/images/wifi.png`} alt="WiFi" />
                    <div className="service-details">
